...
export const adpSchema = z.object({
  ...
  projectBackground: z.string().min(5, "Los antecedentes del proyecto son requeridos"),
  projectObjective: z.string().min(5, "El objetivo del proyecto es requerido"),
  deliverableScope: z.string().min(5, "El alcance del entregable es requerido"),
